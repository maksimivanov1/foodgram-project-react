...
class SubscribeSerializer(GetIsSubscribedMixin, serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if request.user.follower.filter(author=author).exists():
            raise serializers.ValidationError({'errors': 'Уже подписан.'})
        return data
